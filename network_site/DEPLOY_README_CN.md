# NotePassing Network Site 傻瓜部署说明

这份文档面向“不懂 Web 开发”的部署方式。

目标效果：

- 公网首页仍然使用 `http://39.105.30.179:8000/`
- 首页显示网络图网站
- 原来的 NotePassing 后端 API 继续可用
- 不修改原项目结构，只新增独立网站项目并通过 Nginx 转发
...
```bash
http://39.105.30.179:8000/api-health
```
